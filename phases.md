...
Create a set of routes that then display this data as JSON. Users should be given this JSON if they visit the appropriate page (i.e. if a user visits localhost:3000/api/tables they should see a JSON of table data ).
